...
public class LSCustom : Script
{
    ...
    public LSCustom()
    {
        ...
        ls_custom.Add(new LSCustomEnum { position = new Vector3(-369.9495, -108.0081, 38.68046), in_use = false, vehicle = null });
        ls_custom.Add(new LSCustomEnum { position = new Vector3(-360.605, -127.931, 38.69579), in_use = false, vehicle = null });
        ls_custom.Add(new LSCustomEnum { position = new Vector3(-334.7063, -136.8645, 39.00962), in_use = false, vehicle = null });

        foreach (var ls in ls_custom)
        {
            ls.label_position = API.Shared.CreateTextLabel("LSC Tuning", ls.position + new Vector3(0, 0, 1.2f), 10.0f, 8.2f, 4, new Color(255, 255, 255, 255), false, 0);
    ...
    public static void PressKeyE(Client player)
    {
        ...
        foreach (var ls in ls_custom)
        {
            if (FactionManage.GetPlayerGroupType(player) == 11)
            {
    ...
    public static void Display_LSCustom(Client player)
    {
    ...
    public static void Create_LSCustomMainMenu(Client player)
    {
    ...
    public static void Hide_LSCustom(Client player)
    {
        if (player.IsInVehicle && player.VehicleSeat == -1)
        {
