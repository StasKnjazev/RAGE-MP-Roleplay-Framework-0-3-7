...
public class VehicleStreaming : Script
{
    ...
    public void Event_EntityDeleted(NetHandle entity)
    {
        ...
        catch (Exception e) { API.Shared.ConsoleOutput("Event_EntityDeleted: " + e.Message); }
    }
    ...
    public void VehStreamRadioChange(Client client, Vehicle vehicle, short index)
    {
        ...
        catch (Exception e) { API.Shared.ConsoleOutput("VehStream_RadioChange: " + e.Message); }
    }
    ...
    public void VehicleFixStreamIn(Client player, Vehicle veh)
    {
        try
        {
            if (veh != null && NAPI.Entity.DoesEntityExist(veh))
            {
                ...
                /*if (veh.HasData("ACCESS") && veh.GetData("ACCESS") == "PERSONAL") BACKTO
                {
        ...
        catch (Exception e) { API.Shared.ConsoleOutput("VehStream_RequestFixStreamIn: " + e.Message); return; }
    }
    ...
    public void SetVehicleDirtLevel(Client player, Vehicle vehicle, float dirt)
    {
        ...
        catch (Exception e) { API.Shared.ConsoleOutput("VehStream_SetVehicleDirt: " + e.Message); }
    }
    ...
    public static bool UpdateVehicleSyncData(Vehicle veh, VehicleSyncData data)
    {
        ...
        catch (Exception e) { API.Shared.ConsoleOutput("UpdateVehicleSyncData: " + e.Message); return false; }
    }
}
